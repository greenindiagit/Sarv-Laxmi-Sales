    ...
    <div className="container my-5">
      ...
      >
        ...
        <div className="col-md-8">
          ...
          <p>
            <strong>CONTAINER SEAL</strong> IS MANUFACTURED WITH HIGH GRADE STEEL PIN AND PLASTIC.
          </p>
          <p>
            <strong>FEATURE:</strong> Harden Steel Locking Mechanism which reveals the evidence of
            any attempt of Tampering.
          </p>
          <p>
            <strong>APPLICATION:</strong> Cargo Container, Shipping Container, Truck Trailer, Rail
            Freight, Domestic Logistics etc.
          </p>
          <p>
